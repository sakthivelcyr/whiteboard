...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url('buttons.php')?>">Buttons</a>
            <a class="collapse-item" href="<?= base_url('cards.php')?>">Cards</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url('utilities-color.php')?>">Colors</a>
            <a class="collapse-item" href="<?= base_url('utilities-border.php')?>">Borders</a>
            <a class="collapse-item" href="<?= base_url('utilities-animation.php')?>">Animations</a>
            <a class="collapse-item active" href="<?= base_url('utilities-other.php')?>">Other</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url('register.php')?>">Register</a>
            <a class="collapse-item" href="<?= base_url('forgot-password.php')?>">Forgot Password</a>
            <div class="collapse-divider"></div>
            <h6 class="collapse-header">Other Pages:</h6>
            <a class="collapse-item" href="<?= base_url('404.php')?>">404 Page</a>
            <a class="collapse-item" href="<?= base_url('blank.php')?>">Blank Page</a>
          </div>
        </div>
      </li>
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('tables.html')?>">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="<?= base_url('login.php')?>">Logout</a>
        </div>
      </div>
    </div>
  </div>
